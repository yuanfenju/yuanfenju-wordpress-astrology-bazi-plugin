<div class="yfj-form-container" data-module="<?php echo esc_attr($module_id); ?>">
    <div style="text-align: center; margin-bottom: 25px;">
        <h3 style="margin: 0 0 10px 0; color: var(--yfj-text-dark);"><?php echo $this->t('西方占星太阳弧推运盘'); ?></h3>
        <p style="font-size: 13px; color: var(--yfj-text-body); margin: 0;">
            <?php echo $this->t('基于太阳赤经弧的等距推进法则，精准测算人生重大事件与绝对转折点，洞悉命运齿轮转动的关键时机。'); ?>
        </p>
    </div>
    ...
    <form class="yfj-ajax-form">
        ...
        <button type="submit"><?php echo $this->t('推演太阳弧盘'); ?></button>
    </form>
