...
<style>
    ...
    .yfj-block-title { font-weight: bold; color: #b45309; display: inline-block; margin-bottom: 8px; border-bottom: 1px dashed #fcd34d; padding-bottom: 6px; font-size: 15px; }
...
<div class="yfj-lq-wrapper">
    ...
    <div class="yfj-panel">
        ...
        <div class="yfj-panel-body">
            ...
            <div style="float: right; margin: 0 0 15px 15px; border-radius: 6px; border: 1px solid #e2e8f0; overflow: hidden; width: 110px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                <img src="<?php echo esc_url($image_url); ?>" style="width: 100%; display: block; border-bottom: 3px solid #fcd34d;">
            </div>

            <p style="margin: 0 0 10px 0; font-size: 15px;">
                <strong><?php echo $this->t('您抽出佛祖灵签第：'); ?></strong>
            ...
            <p style="margin: 0 0 10px 0; font-size: 15px;">
                ...
                <span style="color: #dc2626; font-weight: bold;">
                    <?php echo esc_html(!empty($fozu['title']) ? $fozu['title'] : $this->t('无')); ?>
                </span>
            </p>
            ...
            <p style="margin: 0 0 10px 0; font-size: 15px;">
                ...
                <span style="background: #fee2e2; color: #dc2626; padding: 2px 10px; border-radius: 4px; font-weight: bold; border: 1px solid #fecaca;">
                    <?php echo esc_html(!empty($content['签级']) ? $content['签级'] : $this->t('未知')); ?>
                </span>
            </p>
            ...
            <!-- 签诗与解签 -->
            <div style="background: #f8fafc; padding: 18px; border-radius: 6px; border: 1px solid #e2e8f0; margin-top: 15px;">
                <p style="margin: 0 0 12px 0;">
                    <strong style="color: #0f172a;"><?php echo $this->t('签诗：'); ?></strong>
                    <span style="color: #b91c1c; font-weight: 500;"><?php echo esc_html($content['签诗'] ?? $this->t('无')); ?></span>
                </p>
                <p style="margin: 0;">
    ...
    <div class="yfj-panel">
        ...
        <div class="yfj-panel-body" style="background: #f8fafc;">
            <div class="yfj-block-grid">
                <?php
                // 佛祖灵签专属的具体解签字段[cite: 3]
                $detail_keys = ['家宅', '岁君', '生意', '谋望', '婚姻', '出外', '开铺', '合伙', '求财'];
    ...
    <div style="text-align: center; margin-top: 10px;">
        <button onclick="jQuery('.yfj-result-area').hide(); jQuery('#yfj-qiuqian-ui').fadeIn(); jQuery('.yfj-ajax-form').show();"
                style="background: #e2e8f0; color: #334155; border: none; padding: 12px 30px; border-radius: 50px; font-size: 14px; font-weight: bold; cursor: pointer;">
