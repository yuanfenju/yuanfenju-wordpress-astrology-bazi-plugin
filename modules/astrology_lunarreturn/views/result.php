...
<div class="yfj-lunar-return-result">
    ...
    <div class="yfj-info-header">
        ...
        <div class="yfj-info-box" style="border-top: 3px solid #ff4c00;">
            <h4 style="margin:0 0 10px 0; color: #ff4c00; font-size: 16px;"><span class="dashicons dashicons-clock"></span> <?php echo $this->t('月返照信息'); ?></h4>
            <p style="margin:4px 0; font-size:13px;"><strong><?php echo $this->t('推运方式：'); ?></strong><?php echo $this->t('月返照'); ?></p>
    ...
    <div class="yfj-svg-wrap">
        <h4 style="margin-top:0; color:#1e293b; font-size: 15px;"><span class="dashicons dashicons-art"></span> <?php echo $this->t('月返照星盘图 (月度盘)'); ?></h4>
        <div class="yfj-svg-item"><?php echo $clean_svg; ?></div>
    </div>

    <div class="yfj-data-section">
        <div class="yfj-table-box">
            <h5 align="center" style="margin: 0 0 15px 0; font-size:15px;"><b><?php echo $this->t('星体落入星座（月返照盘）'); ?></b></h5>
    ...
    <div class="yfj-data-section">
        <div class="yfj-table-box">
            <h5 align="center" style="margin: 0 0 15px 0; font-size:15px;"><b><?php echo $this->t('各宫位置（月返照盘）'); ?></b></h5>
            <table class="yfj-table">
                <thead>
                <tr>
    ...
    <div class="yfj-data-section">
        <div class="yfj-table-box">
            <h5 align="center" style="margin: 0 0 15px 0; font-size:15px;"><b><?php echo $this->t('相位列表（月返照盘内部互动）'); ?></b></h5>
            <table class="yfj-table">
                <thead>
                <tr>
    ...
    <div class="yfj-data-section" style="border: 1px solid #d9534f; border-radius: 4px;">
        <div style="background-color: #f2dede; color: #a94442; padding: 10px 15px; border-bottom: 1px solid #d9534f;">
            <h3 style="margin: 0; font-size: 16px; font-weight: normal;"><span class="dashicons dashicons-book"></span> <?php echo $this->t('月返照月度运势解析报告'); ?></h3>
        </div>
        <div style="padding: 15px; line-height: 1.8;">
            <p style="font-size: 13px; color: #666; margin-bottom: 15px;">*注：<?php echo $this->t('月返照盘是当天空中的月亮准确回到你出生那一刻月亮的度数时打出的一张星盘，用于预测未来28天左右的短期运势、情绪起伏和焦点事件。'); ?></p>
